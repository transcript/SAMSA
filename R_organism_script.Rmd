...
tail(res, 10)
plotMA(dds, ylim=c(-4.5,4.5), main="DESeq2 analysis of all organisms")

org_results <- data.frame(res[order(res$baseMean, decreasing = TRUE),])
write.table(org_results, file = "DESeq_public_data_organism_output.tab", append = FALSE, quote = FALSE, sep = "\t", row.names = TRUE, col.names = TRUE)
