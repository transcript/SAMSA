...
# taxonomy_shifter_v2.py
# Created 12/03/15, by Sam Westreich, stwestreich@ucdavis.edu
...
# Version 2 is going to try and have fewer errors by checking at multiple levels, assuming some failure to identify the input correctly at first.
# Version 3 (this one) will have the option to exclude all mismatches.
